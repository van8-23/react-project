...
export const mockedCoursesList: Course[] = [
  ...
  },
  {
   ...
   {
    id: 'c7777777-8888-9999-aaaa-bbbbbbbbbbbb',
    title: 'ASP .NET',
    description:
...
export const mockedAuthorsList: Author[] = [
  ...
  { id: 'a1111111-2222-3333-4444-555555555555', name: 'Sam Smith' },
  { id: 'b2222222-3333-4444-5555-666666666666', name: 'Tony Robbins' },
];
